...
REQUIRED_ENV = "AGENT_LEARNING_SDK_WORKSPACE_OBSERVABILITY_SIMULATION_KEY"
REPOSITORY_URL = "https://github.com/futureagi/support-agent"
COMMIT_SHA = "abc123def4567890"


def build_manifest() -> dict[str, Any]:
    return simulate.build_workspace_observability_run_manifest(
        name="sdk-workspace-observability-simulation",
        required_env=[REQUIRED_ENV],
        repository_url=REPOSITORY_URL,
        commit_sha=COMMIT_SHA,
        metadata={"cookbook": "sdk-workspace-observability-simulation"},
    )

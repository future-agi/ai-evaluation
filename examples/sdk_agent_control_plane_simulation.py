...
REQUIRED_ENV = "AGENT_LEARNING_SDK_AGENT_CONTROL_PLANE_SIMULATION_KEY"


def build_manifest() -> dict[str, Any]:
    return simulate.build_agent_control_plane_run_manifest(
        name="sdk-agent-control-plane-simulation",
        required_env=[REQUIRED_ENV],
        metadata={"cookbook": "sdk-agent-control-plane-simulation"},
    )

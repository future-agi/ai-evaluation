...
REQUIRED_ENV = "AGENT_LEARNING_SDK_BROWSER_CUA_SIMULATION_KEY"


def build_manifest() -> dict[str, Any]:
    return simulate.build_browser_cua_run_manifest(
        name="sdk-browser-cua-simulation",
        required_env=[REQUIRED_ENV],
        metadata={"cookbook": "sdk-browser-cua-simulation"},
    )

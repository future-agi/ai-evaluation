...
def _memory_optimization_example() -> Any:
...
def build_manifest() -> dict[str, Any]:
    memory_example = _memory_optimization_example()
    return simulate.build_memory_layer_run_manifest(
        name="sdk-memory-simulation",
        required_env=[REQUIRED_ENV],
        memory=memory_example.strong_candidate(),
        evaluation_config=memory_example.evaluation_config(),
        threshold=0.9,
        metadata={"cookbook": "sdk-memory-simulation"},
    )

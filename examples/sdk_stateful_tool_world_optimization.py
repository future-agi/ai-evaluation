...
def build_manifest() -> dict[str, Any]:
    return optimize.build_stateful_tool_world_optimization_manifest(
        name="sdk-stateful-tool-world-optimization",
        required_env=[REQUIRED_ENV],
        target_metadata={"cookbook": "sdk-stateful-tool-world-optimization"},
    )
...
def run(output_path: str | Path | None = None) -> dict[str, Any]:
    ...
    result = optimize.optimize_stateful_tool_world(
        name="sdk-stateful-tool-world-optimization",
        required_env=[REQUIRED_ENV],
        target_metadata={"cookbook": "sdk-stateful-tool-world-optimization"},

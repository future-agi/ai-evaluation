...
def build_manifest() -> dict[str, Any]:
    return simulate.build_multi_agent_framework_handoff_run_manifest(
        name="sdk-multi-agent-framework-handoff-simulation",
        required_env=[REQUIRED_ENV],
        export_source_base_dir=Path(__file__).parent,
        metadata={"cookbook": "sdk-multi-agent-framework-handoff-simulation"},
    )
